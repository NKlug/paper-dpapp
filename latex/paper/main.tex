...
\begin{document}
    ...
    \begin{figure}
		\makebox[\textwidth][c]{\includegraphics[width=1.1\textwidth]{split_tree}}
		\caption{Fairer Split-Tree für die Menge $S=[0.0, 5.0, 9.1, 17.2, 32.2, 37.6, 44.3, 54.3, 67.9, 81.0, 95.4, 96.4, 141.5]$. Die Knoten des Baumes sind damit dem Intervall beschriftet, das mit ihnen gespeichert ist.}
		\label{fig:splittree}
    \end{figure}
