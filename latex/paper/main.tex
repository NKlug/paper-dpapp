...
\begin{document}
    ...
    \begin{abstract}
        ...
        Diese Arbeit stellt exakte und approximative Algorithmen dar, um $Q$ so zu berechnen, dass $Q$ für festes $t$ die minimale Zahl von Knoten besitzt oder für eine feste Knotenzahl minimales $t$ hat.
    \end{abstract}
