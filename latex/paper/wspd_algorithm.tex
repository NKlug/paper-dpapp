\begin{figure}
	...
	\begin{minipage}{.8\linewidth}
		...
		\begin{algorithmic}[H]
			...
			\STATE \texttt{find\_pairs(v, w)} \{
			\begin{ALC@g}
				\IF{$S_v$ und $S_w$ sind bezüglich $s$ nicht wohl-separiert}
					\STATE Seien $[i, j]$ und $[k, l]$ die Intervalle die mit $v$ bzw. $w$ gespeichert sind;
						...
						\ENDIF
				\ELSE
					\STATE Speichere in $v$ und $w$, dass deren Blätter die Teilmengen $A$ und $B$ einer WSPD bilden;
				\ENDIF
			\end{ALC@g}
