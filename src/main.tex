...
\begin{document}
    ...
    Seien $u, v \in \R^d$, dann definieren wir $|uv|$ als den euklidischen Abstand dieser beiden Punkte.
    Sind $p_i, p_j \in P$ dann sei $\delta(p_i, p_j) \coloneqq \sum\limits_{i=1}^{n-1}{|p_i
    p_{i+1}|}$, also der euklidische Abstand dieser beiden Punkte entlang des Pfades $P$.
    ...
    \begin{proof}
    	...
    	\begin{align*}    	
	    	...
	    	&\Leftrightarrow \qquad 2 \,\geq\, (1 + \frac{4}{s})(1 + \frac{\epsilon}{3})
