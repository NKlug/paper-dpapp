...
\begin{document}
    ...
    Die beiden approximativen Algorithmen, die wir betrachten werden, basieren auf einer sogenannten Zerlegung in wohl-separierte Paare. Da diese Zerlegung einen wesentlichen Teil beider Algorithmen ausmacht, werden wir sie zunächst genauer definieren und einen Algorithmus zur Berechnung angeben.
