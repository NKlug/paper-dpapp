   ...
   \label{subsec:def}
	...
	Wir nennen eine t-distanzerhaltende Approximation eines Pfades \emph{minimal} bzw. eine \emph{minimale}, falls sie die geringst mögliche Zahl an Knoten besitzt.
